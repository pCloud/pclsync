/* OpenSSL 1.1.x network integration test driver.
 *
 * Build:  make check-network-openssl   (requires OpenSSL 1.1.x)
 * Run:    ./tests/check_network_openssl
 */
...
static Suite *network_openssl_suite(void) {
  Suite *s = suite_create("network_openssl");
